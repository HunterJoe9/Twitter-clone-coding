          ...
          <div className="border-t-[0.5px] px-4 border-b-[0.5px] flex items-stretch py-6 space-x-2 border-gray-600 relative">
            ...
            <div className="w-full justify-between items-center flex">
              ...
              <div className="w-full max-w-[100px]">
                <button className='rounded-full bg-primary px-4 py-2 w-full text-lg text-center hover:bg-opacity-70 transiton duration-200 font-bold'>
                  Tweet
                </button>
              </div>
            </div>
                ...
                <div key={i} className="border-b-[0.5px] border-gray-600 p-2 flex space-x-4">
                  ...
                  <div className="flex flex-col">
                    ...
                    <div className="text-white text-base">
                      Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugiat vero voluptatem odit facilis ducimus sunt saepe, repellat mollitia voluptatibus omnis et. At iure inventore quam autem ea tenetur assumenda beatae.
                    </div>
                    <div className="bg-slate-400 aspect-square w-full h-80 rounded-xl mt-2"></div>
                    <div className="flex item-center justify-start space-x-20 mt-4 w-full">
